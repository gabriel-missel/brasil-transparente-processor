...
@Service
public class SenadoLineParser implements LineParser {
    ...
    public Optional<DadosDespesa> parse(String[] rawList) {
        if (rawList.length == 2) {
            ...
            return Optional.of(new DadosDespesa(CAMARA_DEPUTADOS, CAMARA_DEPUTADOS, CAMARA_DEPUTADOS, elementoDespesa, valor));
        }
        return Optional.empty();
    }
}
