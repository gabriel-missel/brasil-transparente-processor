...
public class NameCorrector {
    ...
    private void correctMinisterioNames(Ministerio ministerio) {
        String updatedName = switch (ministerio.getNameMinisterio()) {
            ...
            case "SECRETARIA DA FAZENDA" -> "Secretaria da Fazenda";
            case "SECRETARIA DA SEGURANCA PUBLICA" -> "Secretaria da Segurança Pública";
            case "SECRETARIA DA EDUCACAO" -> "Secretaria da Educação";
            case "SECRETARIA DA SAUDE" -> "Secretaria da Saúde";
            case "SECRETARIA DE LOGISTICA E TRANSPORTES" -> "Secretaria de Logística e Transportes";
            case "SECRETARIA DE SISTEMAS PENAL E SOCIOEDUCATIVO" -> "Secretaria de Sistemas Penal e Socioeducativo";
            case "SECRETARIA DE DESENVOLVIMENTO SOCIAL" -> "Secretaria de Desenvolvimento Social";
            case "GOVERNO DO ESTADO" -> "Governo do Estado";
            case "SECRETARIA DA AGRICULTURA, PECUARIA, PRODUCAO SUSTENTAVEL E IRRIGACAO" -> "Secretaria da Agricultura, Pecuária, Produção Sustentável e Irrigação";
            case "SECRETARIA DE PLANEJAMENTO, GOVERNANCA E GESTAO" -> "Secretaria de Planejamento, Governança e Gestão";
            case "PROCURADORIA-GERAL DO ESTADO" -> "Procuradoria-Geral do Estado";
            case "SECRETARIA DE DESENVOLVIMENTO ECONOMICO" -> "Secretaria de Desenvolvimento Econômico";
            case "SECRETARIA DE DESENVOLVIMENTO URBANO E METROPOLITANO" -> "Secretaria de Desenvolvimento Urbano e Metropolitano";
            case "SECRETARIA DE HABITACAO E REGULARIZACAO FUNDIARIA" -> "Secretaria de Habitação e Regularização Fundiária";
            case "SECRETARIA DE DESENVOLVIMENTO RURAL" -> "Secretaria de Desenvolvimento Rural";
            case "SECRETARIA DO MEIO AMBIENTE E INFRAESTRUTURA" -> "Secretaria do Meio Ambiente e Infraestrutura";
            case "SECRETARIA DA CULTURA" -> "Secretaria da Cultura";
            case "SECRETARIA DE INOVACAO, CIENCIA E TECNOLOGIA" -> "Secretaria de Inovação, Ciência e Tecnologia";
            case "SECRETARIA DE OBRAS PUBLICAS" -> "Secretaria de Obras Públicas";
            case "SECRETARIA DE TURISMO" -> "Secretaria de Turismo";
            case "SECRETARIA DE JUSTICA, CIDADANIA E DIREITOS HUMANOS" -> "Secretaria de Justiça, Cidadania e Direitos Humanos";
            case "SECRETARIA DO ESPORTE E LAZER" -> "Secretaria do Esporte e Lazer";
            case "SECRETARIA DE TRABALHO E DESENVOLVIMENTO PROFISSIONAL" -> "Secretaria de Trabalho e Desenvolvimento Profissional";
            case "SECRETARIA DE PARCERIAS E CONCESSOES" -> "Secretaria de Parcerias e Concessões";
            case "SECRETARIA DA RECONSTRUCAO GAUCHA" -> "Secretaria da Reconstrução Gaúcha";
            case "TRIBUNAL DE JUSTICA" -> "Tribunal de Justiça";
            case "JUSTICA MILITAR DO ESTADO" -> "Justiça Militar do Estado";
            case "MINISTERIO PUBLICO" -> "Ministério Público";
            case "TRIBUNAL DE CONTAS DO ESTADO" -> "Tribunal de Contas do Estado";
            case "DEFENSORIA PUBLICA DO ESTADO" -> "Defensoria Pública do Estado";
            case "ASSEMBLEIA LEGISLATIVA" -> "Assembleia Legislativa";
    ...
    private void correctOrgaoNames(Orgao orgao) {
        String updatedName = switch (orgao.getNameOrgao()) {
            ...
            case "CONSELHO NACIONAL DE JUSTICA" -> "Conselho Nacional de Justiça";
            case "JUSTICA MILITAR" -> "Justiça Militar";
            case "INSTITUTO DE PREVIDENCIA DO ESTADO DO RIO GRANDE DO SUL" -> "Instituto de Previdência do Estado do Rio Grande do Sul";
            case "ENCARGOS FINANCEIROS DO ESTADO" -> "Encargos Financeiros do Estado";
            case "INSTITUTO DE ASSISTENCIA A SAUDE DOS SERVIDORES PUBLICOS DO RIO GRANDE DO SUL" -> "Instituto de Assistência à Saúde dos Servidores Públicos do Rio Grande do Sul";
            case "SECRETARIA DA FAZENDA" -> "Secretaria da Fazenda";
            case "SECRETARIA DA SEGURANCA PUBLICA" -> "Secretaria da Segurança Pública";
            case "DEPARTAMENTO ESTADUAL DE TRANSITO" -> "Departamento Estadual de Trânsito";
            case "SECRETARIA DA EDUCACAO" -> "Secretaria da Educação";
            case "UNIVERSIDADE ESTADUAL DO RIO GRANDE DO SUL" -> "Universidade Estadual do Rio Grande do Sul";
            case "FUNDACAO ESCOLA TECNICA LIBERATO SALZANO VIEIRA DA CUNHA" -> "Fundação Escola Técnica Liberato Salzano Vieira da Cunha";
            case "CONSELHO ESTADUAL DE EDUCACAO" -> "Conselho Estadual de Educação";
            case "SECRETARIA DA SAUDE" -> "Secretaria da Saúde";
            case "DEPARTAMENTO AUTONOMO DE ESTRADAS DE RODAGEM" -> "Departamento Autônomo de Estradas de Rodagem";
            case "SECRETARIA DE LOGISTICA E TRANSPORTES" -> "Secretaria de Logística e Transportes";
            case "SECRETARIA DE SISTEMAS PENAL E SOCIOEDUCATIVO" -> "Secretaria de Sistemas Penal e Socioeducativo";
            case "SECRETARIA DE DESENVOLVIMENTO SOCIAL" -> "Secretaria de Desenvolvimento Social";
            case "FUNDACAO DE ATENDIMENTO SOCIO-EDUCATIVO DO RIO GRANDE DO SUL" -> "Fundação de Atendimento Socioeducativo do Rio Grande do Sul";
            case "FUNDACAO DE PROTECAO ESPECIAL DO RIO GRANDE DO SUL" -> "Fundação de Proteção Especial do Rio Grande do Sul";
            case "FUNDACAO GAUCHA DO TRABALHO E ACAO SOCIAL" -> "Fundação Gaúcha do Trabalho e Ação Social";
            case "FUNDACAO DE ARTICULACAO E DESENVOLVIMENTO DE POLITICAS PUBLICAS PARA PPD E PPAH" -> "Fundação de Articulação e Desenvolvimento de Políticas Públicas para Pessoas com Deficiência e Pessoas com Altas Habilidades";
            case "GOVERNO DO ESTADO" -> "Governo do Estado";
            case "SECRETARIA DA AGRICULTURA, PECUARIA, PRODUCAO SUSTENTAVEL E IRRIGACAO" -> "Secretaria da Agricultura, Pecuária, Produção Sustentável e Irrigação";
            case "INSTITUTO RIOGRANDENSE DO ARROZ" -> "Instituto Riograndense do Arroz";
            case "SECRETARIA DE PLANEJAMENTO, GOVERNANCA E GESTAO" -> "Secretaria de Planejamento, Governança e Gestão";
            case "FUNDACAO ESTADUAL DE PLANEJAMENTO METROPOLITANO E REGIONAL" -> "Fundação Estadual de Planejamento Metropolitano e Regional";
            case "ESCRITORIO DE DESENVOLVIMENTO DE PROJETOS" -> "Escritório de Desenvolvimento de Projetos";
            case "PROCURADORIA-GERAL DO ESTADO" -> "Procuradoria-Geral do Estado";
            case "SECRETARIA DE DESENVOLVIMENTO ECONOMICO" -> "Secretaria de Desenvolvimento Econômico";
            case "JUNTA COMERCIAL, INDUSTRIAL E SERVICOS DO RIO GRANDE DO SUL" -> "Junta Comercial, Industrial e de Serviços do Rio Grande do Sul";
            case "SECRETARIA DE DESENVOLVIMENTO URBANO E METROPOLITANO" -> "Secretaria de Desenvolvimento Urbano e Metropolitano";
            case "SECRETARIA DE HABITACAO E REGULARIZACAO FUNDIARIA" -> "Secretaria de Habitação e Regularização Fundiária";
            case "SECRETARIA DE DESENVOLVIMENTO RURAL" -> "Secretaria de Desenvolvimento Rural";
            case "SECRETARIA DO MEIO AMBIENTE E INFRAESTRUTURA" -> "Secretaria do Meio Ambiente e Infraestrutura";
            case "FUNDACAO ESTADUAL DE PROTECAO AMBIENTAL HENRIQUE LUIS ROESSLER" -> "Fundação Estadual de Proteção Ambiental Henrique Luís Roessler";
            case "SECRETARIA DA CULTURA" -> "Secretaria da Cultura";
            case "FUNDACAO ORQUESTRA SINFONICA DE PORTO ALEGRE" -> "Fundação Orquestra Sinfônica de Porto Alegre";
            case "FUNDACAO TEATRO SAO PEDRO" -> "Fundação Teatro São Pedro";
            case "SECRETARIA DE INOVACAO, CIENCIA E TECNOLOGIA" -> "Secretaria de Inovação, Ciência e Tecnologia";
            case "FUNDACAO DE AMPARO A PESQUISA DO ESTADO DO RIO GRANDE DO SUL" -> "Fundação de Amparo à Pesquisa do Estado do Rio Grande do Sul";
            case "SECRETARIA DE OBRAS PUBLICAS" -> "Secretaria de Obras Públicas";
            case "SECRETARIA DE TURISMO" -> "Secretaria de Turismo";
            case "SECRETARIA DE JUSTICA, CIDADANIA E DIREITOS HUMANOS" -> "Secretaria de Justiça, Cidadania e Direitos Humanos";
            case "SECRETARIA DO ESPORTE E LAZER" -> "Secretaria do Esporte e Lazer";
            case "SECRETARIA DE TRABALHO E DESENVOLVIMENTO PROFISSIONAL" -> "Secretaria de Trabalho e Desenvolvimento Profissional";
            case "AGENCIA ESTADUAL DE REGULACAO DOS SERVICOS PUBLICOS DELEGADOS DO RS" -> "Agência Estadual de Regulação dos Serviços Públicos Delegados do Rio Grande do Sul";
            case "SECRETARIA DE PARCERIAS E CONCESSOES" -> "Secretaria de Parcerias e Concessões";
            case "SECRETARIA DA RECONSTRUCAO GAUCHA" -> "Secretaria da Reconstrução Gaúcha";
            case "TRIBUNAL DE JUSTICA" -> "Tribunal de Justiça";
            case "JUSTICA MILITAR DO ESTADO" -> "Justiça Militar do Estado";
    ...
    private void correctUnidadeGestoraNames4(UnidadeGestora unidadeGestora) {
        String updatedName = switch (unidadeGestora.getNameUnidadeGestora()) {
            ...
            case "APOSENTADORIAS E REFORMAS" -> "Aposentadorias e Reformas";
            ...
            case "COMPENSAÇÕES A REGIMES DE PREVIDÊNCIA" -> "Compensações a Regimes de Previdência";
            ...
            case "SERVICOS DE TECNOLOGIA DA INFORMACAO E COMUNICACAO - PESSOA JURIDICA" -> "Serviços de Tecnologia da Informação e Comunicação - Pessoa Jurídica";
            case "OUTROS BENEFICIOS ASSISTENCIAIS DO SERVIDOR E DO MILITAR" -> "Outros Benefícios Assistenciais do Servidor e do Militar";
            ...
            case "RESSARCIMENTO DE DESPESAS DE PESSOAL REQUISITADO" -> "Ressarcimento de Despesas de Pessoal Requisitado";
            ...
            case "CONTRIBUICAO A ENTIDADES FECHADAS DE PREVIDENCIA" -> "Contribuição a Entidades Fechadas de Previdência";
            case "OUTROS SERVICOS DE TERCEIROS - PESSOA FISICA" -> "Outros Serviços de Terceiros - Pessoa Física";
            case "JUROS SOBRE A DIVIDA POR CONTRATO" -> "Juros sobre a Dívida por Contrato";
            case "CONSTITUICAO OU AUMENTO DE CAPITAL DE EMPRESAS" -> "Constituição ou Aumento de Capital de Empresas";
            case "PRINCIPAL DA DIVIDA CONTRATUAL RESGATADO" -> "Principal da Dívida Contratual Resgatado";
            case "PENSOES ESPECIAIS" -> "Pensões Especiais";
            case "OUTROS ENCARGOS SOBRE A DIVIDA POR CONTRATO" -> "Outros Encargos sobre a Dívida por Contrato";
            ...
            case "PREMIACOES CULTURAIS/ ARTISTICAS/ CIENTIFICAS/ DESPORTIVAS OU OUTRAS" -> "Premiações Culturais/Artísticas/Científicas/Desportivas ou Outras";
            case "OUTROS AUXILIOS FINANCEIROS A PESSOAS FISICAS" -> "Outros Auxílios Financeiros a Pessoas Físicas";
            case "DIARIAS-MILITAR" -> "Diárias - Militar";
            case "VENCIMENTOS E VANTAGENS FIXAS-PESSOAL MILITAR" -> "Vencimentos e Vantagens Fixas - Pessoal Militar";
            case "OUTRAS DESPESAS VARIAVEIS-PESSOAL MILITAR" -> "Outras Despesas Variáveis - Pessoal Militar";
            case "SUBVENCOES SOCIAIS" -> "Subvenções Sociais";
            case "AUXILIOS" -> "Auxílios";
            case "MATERIAL, BEM OU SERVICO PARA DISTRIBUICAO GRATUITA" -> "Material, Bem ou Serviço para Distribuição Gratuita";
            case "AUXILIO FARDAMENTO" -> "Auxílio-Fardamento";
            case "AUXILIO FINANCEIRO A ESTUDANTES" -> "Auxílio Financeiro a Estudantes";
            case "CONTRATACAO POR TEMPO DETERMINADO" -> "Contratação por Tempo Determinado";
            case "OUTROS BENEFICIOS ASSISTENCIAS" -> "Outros Benefícios Assistenciais";
            ...
            case "CONTRATO DE GESTAO" -> "Contrato de Gestão";
            case "CONCESSAO DE EMPRESTIMOS E FINANCIAMENTOS" -> "Concessão de Empréstimos e Financiamentos";
            case "RPPS/RS REPARTICAO SIMPLES - FUNDO FINANCEIRO IPE PREV" -> "RPPS/RS Repartição Simples - Fundo Financeiro IPE Prev";
            case "ENCARGOS GERAIS DO REGIME PROPRIO DE PREVIDENCIA SOCIAL" -> "Encargos Gerais do Regime Próprio de Previdência Social";
            case "ADMINISTRACAO" -> "Administração";
            case "FUNDOPREV CIVIL" -> "Fundoprev Civil";
            case "FUNDOPREV MILITAR" -> "Fundoprev Militar";
            case "ENCARGOS GERAIS DO PODER EXECUTIVO" -> "Encargos Gerais do Poder Executivo";
            case "SERVICO DA DIVIDA PUBLICA" -> "Serviço da Dívida Pública";
            case "ASSISTENCIA MEDICA" -> "Assistência Médica";
            case "ENCARGOS GERAIS DO FUNDO DE ASSISTENCIA A SAUDE" -> "Encargos Gerais do Fundo de Assistência à Saúde";
            case "GABINETE E ORGAOS CENTRAIS" -> "Gabinete e Órgãos Centrais";
            case "SUBSECRETARIA DA RECEITA ESTADUAL" -> "Subsecretaria da Receita Estadual";
            case "FUNDO DE MODERNIZACAO E REAPARELHAMENTO DA SECRETARIA DA FAZENDA DO ESTADO/RS" -> "Fundo de Modernização e Reaparelhamento da Secretaria da Fazenda do Estado/RS";
            case "BRIGADA MILITAR" -> "Brigada Militar";
            case "POLICIA CIVIL" -> "Polícia Civil";
            case "CORPO DE BOMBEIROS MILITAR" -> "Corpo de Bombeiros Militar";
            case "INSTITUTO GERAL DE PERICIAS" -> "Instituto Geral de Perícias";
            case "DEPARTAMENTO ESTADUAL DE TRANSITO" -> "Departamento Estadual de Trânsito";
            case "ENCARGOS GERAIS DO DEPARTAMENTO ESTADUAL DE TRANSITO" -> "Encargos Gerais do Departamento Estadual de Trânsito";
            case "ENCARGOS GERAIS DA SECRETARIA DA EDUCACAO" -> "Encargos Gerais da Secretaria da Educação";
            case "SUPERINTENDENCIA DA EDUCACAO PROFISSIONAL DO ESTADO DO RS" -> "Superintendência da Educação Profissional do Estado do RS";
            case "UNIVERSIDADE ESTADUAL DO RIO GRANDE DO SUL" -> "Universidade Estadual do Rio Grande do Sul";
            case "ENCARGOS GERAIS DA UNIVERSIDADE ESTADUAL DO RIO GRANDE DO SUL" -> "Encargos Gerais da Universidade Estadual do Rio Grande do Sul";
            case "FUNDACAO ESCOLA TECNICA LIBERATO SALZANO VIEIRA DA CUNHA" -> "Fundação Escola Técnica Liberato Salzano Vieira da Cunha";
            case "ENCARGOS GERAIS DA FUNDACAO ESCOLA TECNICA LIBERATO SALZANO VIEIRA DA CUNHA" -> "Encargos Gerais da Fundação Escola Técnica Liberato Salzano Vieira da Cunha";
            case "CONSELHO ESTADUAL DE EDUCACAO" -> "Conselho Estadual de Educação";
            case "FUNDO ESTADUAL DE SAUDE" -> "Fundo Estadual de Saúde";
            case "ENCARGOS GERAIS DA SECRETARIA ESTADUAL DA SAUDE" -> "Encargos Gerais da Secretaria Estadual da Saúde";
            case "FUNDO DE APOIO FINANCEIRO E DE RECUPERACAO DOS HOSPITAIS PRIVADOS E PUBLICOS" -> "Fundo de Apoio Financeiro e de Recuperação dos Hospitais Privados e Públicos";
            case "DEPARTAMENTO AUTONOMO DE ESTRADAS DE RODAGEM" -> "Departamento Autônomo de Estradas de Rodagem";
            case "ENCARGOS GERAIS DO DEPARTAMENTO AUTONOMO DE ESTRADAS DE RODAGEM" -> "Encargos Gerais do Departamento Autônomo de Estradas de Rodagem";
            case "SUPERINTENDENCIA DOS SERVICOS PENITENCIARIOS - SUSEPE" -> "Superintendência dos Serviços Penitenciários - SUSEPE";
            case "ENCARGOS GERAIS DA SECRETARIA DE SISTEMAS PENAL E SOCIOEDUCATIVO" -> "Encargos Gerais da Secretaria de Sistemas Penal e Socioeducativo";
            case "FUNDO PENITENCIARIO" -> "Fundo Penitenciário";
            case "FUNDO ESTADUAL DE ASSISTENCIA SOCIAL" -> "Fundo Estadual de Assistência Social";
            case "FUNDO ESTADUAL DA PESSOA IDOSA" -> "Fundo Estadual da Pessoa Idosa";
            case "FUNDACAO DE ATENDIMENTO SOCIO-EDUCATIVO DO RIO GRANDE DO SUL" -> "Fundação de Atendimento Socioeducativo do Rio Grande do Sul";
            case "ENCARGOS GERAIS DA FUNDACAO DE ATENDIMENTO SOCIO-EDUCATIVO DO RIO GRANDE DO SUL" -> "Encargos Gerais da Fundação de Atendimento Socioeducativo do Rio Grande do Sul";
            case "FUNDACAO DE PROTECAO ESPECIAL DO RIO GRANDE DO SUL" -> "Fundação de Proteção Especial do Rio Grande do Sul";
            case "ENCARGOS GERAIS DA FUNDACAO DE PROTECAO ESPECIAL DO RIO GRANDE DO SUL" -> "Encargos Gerais da Fundação de Proteção Especial do Rio Grande do Sul";
            case "FUNDACAO GAUCHA DO TRABALHO E ACAO SOCIAL" -> "Fundação Gaúcha do Trabalho e Ação Social";
            case "ENCARGOS GERAIS DA FUNDACAO GAUCHA DO TRABALHO E ACAO SOCIAL" -> "Encargos Gerais da Fundação Gaúcha do Trabalho e Ação Social";
            case "FUNDACAO DE ARTIC. E DESENV. DE POLITICAS PUBLICAS PARA PPD E PPAH NO RGS" -> "Fundação de Articulação e Desenvolvimento de Políticas Públicas para PPD e PPAH no RGS";
            case "ENCARGOS GERAIS DA FUNDACAO DE ARTIC. E DESENV. DE POLITICAS PUBLICAS PARA PPD E" -> "Encargos Gerais da Fundação de Articulação e Desenvolvimento de Políticas Públicas para PPD e";
            case "FUNDO ESTADUAL DE DEFESA CIVIL DO ESTADO DO RIO GRANDE DO SUL" -> "Fundo Estadual de Defesa Civil do Estado do Rio Grande do Sul";
            case "SECRETARIA DE COMUNICACAO" -> "Secretaria de Comunicação";
            case "CASA CIVIL DO GABINETE DO GOVERNADOR" -> "Casa Civil do Gabinete do Governador";
            case "CASA MILITAR DO GABINETE DO GOVERNADOR" -> "Casa Militar do Gabinete do Governador";
            case "GABINETE DO VICE-GOVERNADOR" -> "Gabinete do Vice-Governador";
            case "FUNDO ESTADUAL DE ASSISTENCIA TECNICA E EXTENSAO RURAL E SOCIAL" -> "Fundo Estadual de Assistência Técnica e Extensão Rural e Social";
            case "ENCARGOS GERAIS DA SECRETARIA DA AGRICULTURA E ABASTECIMENTO" -> "Encargos Gerais da Secretaria da Agricultura e Abastecimento";
            case "FUNDO DE DESENVOLVIMENTO DA VITIVINICULTURA" -> "Fundo de Desenvolvimento da Vitivinicultura";
            case "FUNDO DO PARQUE ESTADUAL DE EXPOSICOES ASSIS BRASIL" -> "Fundo do Parque Estadual de Exposições Assis Brasil";
            case "FUNDO DE APOIO AO SETOR PRIMARIO" -> "Fundo de Apoio ao Setor Primário";
            case "SUBSECRETARIA PARQUE ESTADUAL DE EXPOSICAO ASSIS BRASIL" -> "Subsecretaria Parque Estadual de Exposição Assis Brasil";
            case "FUNDO DE DESENVOLVIMENTO DA OVINICULTURA DO ESTADO" -> "Fundo de Desenvolvimento da Ovinicultura do Estado";
            case "DEPARTAMENTO DE DIAGNOSTICO E PESQUISA AGROPECUARIA" -> "Departamento de Diagnóstico e Pesquisa Agropecuária";
            case "FUNDO ESTADUAL DO LEITE" -> "Fundo Estadual do Leite";
            case "INSTITUTO RIO-GRANDENSE DO ARROZ" -> "Instituto Rio-Grandense do Arroz";
            case "ENCARGOS GERAIS DO INSTITUTO RIOGRANDENSE DO ARROZ" -> "Encargos Gerais do Instituto Rio-Grandense do Arroz";
            case "SERVICOS TRANSVERSAIS - CONTRATOS CENTRALIZADOS" -> "Serviços Transversais - Contratos Centralizados";
            case "FUNDO ESTADUAL DE GESTAO PATRIMONIAL - FEGEP" -> "Fundo Estadual de Gestão Patrimonial - FEGEP";
            case "FUNDACAO ESTADUAL DE PLANEJAMENTO METROPOLITANO E REGIONAL" -> "Fundação Estadual de Planejamento Metropolitano e Regional";
            case "ENCARGOS GERAIS DA FUNDACAO ESTADUAL DE PLANEJAMENTO METROPOLITANO E REGIONAL" -> "Encargos Gerais da Fundação Estadual de Planejamento Metropolitano e Regional";
            case "ESCRITORIO DE DESENVOLVIMENTO DE PROJETOS" -> "Escritório de Desenvolvimento de Projetos";
            case "ENCARGOS GERAIS DO ESCRITORIO DE DESENVOLVIMENTO DE PROJETOS" -> "Encargos Gerais do Escritório de Desenvolvimento de Projetos";
            case "PROCURADORIA-GERAL DO ESTADO" -> "Procuradoria-Geral do Estado";
            case "FUNDO DE REAPARELHAMENTO DA PROCURADORIA GERAL DO ESTADO" -> "Fundo de Reaparelhamento da Procuradoria Geral do Estado";
            case "ESCOLA SUP DE ADV DE ESTADO PROF ALMIRO DO COU" -> "Escola Superior de Advocacia do Estado Prof. Almiro do Cou";
            case "JUNTA COMERCIAL, INDUSTRIAL E SERVICOS DO RIO GRANDE DO SUL" -> "Junta Comercial, Industrial e Serviços do Rio Grande do Sul";
            case "ENCARGOS GERAIS DA JUNTA COMERCIAL, INDUSTRIAL E SERVICOS DO RIO GRANDE DO SUL" -> "Encargos Gerais da Junta Comercial, Industrial e Serviços do Rio Grande do Sul";
            case "FUNDO ESTADUAL DE HABITACAO DE INTERESSE SOCIAL" -> "Fundo Estadual de Habitação de Interesse Social";
            case "FUNDO ESTADUAL DE APOIO AO DESENVOLVIMENTO DE PEQUENOS ESTABELECIMENTOS RURAIS" -> "Fundo Estadual de Apoio ao Desenvolvimento de Pequenos Estabelecimentos Rurais";
            case "FUNDO DE TERRAS DO RGS" -> "Fundo de Terras do RGS";
            case "FUNDACAO ESTADUAL DE PROTECAO AMBIENTAL HENRIQUE LUIS ROESSLER" -> "Fundação Estadual de Proteção Ambiental Henrique Luís Roessler";
            case "ENCARGOS GERAIS DA FUNDACAO ESTADUAL DE PROTECAO AMBIENTAL HENRIQUE LUIS ROESSLE" -> "Encargos Gerais da Fundação Estadual de Proteção Ambiental Henrique Luís Roessler";
            case "FUNDO DE APOIO A CULTURA DO ESTADO DO RIO GRANDE DO SUL" -> "Fundo de Apoio à Cultura do Estado do Rio Grande do Sul";
            case "FUNDACAO ORQUESTRA SINFONICA DE PORTO ALEGRE" -> "Fundação Orquestra Sinfônica de Porto Alegre";
            case "ENCARGOS GERAIS DA FUNDACAO ORQUESTRA SINFONICA DE PORTO ALEGRE" -> "Encargos Gerais da Fundação Orquestra Sinfônica de Porto Alegre";
            case "FUNDACAO TEATRO SAO PEDRO" -> "Fundação Teatro São Pedro";
            case "ENCARGOS GERAIS DO TEATRO SAO PEDRO" -> "Encargos Gerais do Teatro São Pedro";
            case "FUNDACAO DE AMPARO A PESQUISA DO ESTADO DO RGS" -> "Fundação de Amparo à Pesquisa do Estado do RGS";
            case "ENCARGOS GERAIS DA FUNDACAO DE AMPARO A PESQUISA DO ESTADO DO RGS" -> "Encargos Gerais da Fundação de Amparo à Pesquisa do Estado do RGS";
            case "DEPARTAMENTO DE IRRIGACAO" -> "Departamento de Irrigação";
            case "FUNDO ESTADUAL DOS DIREITOS DA PESSOA COM DEFICIENCIA E ALTAS HABILIDADES - FUN" -> "Fundo Estadual dos Direitos da Pessoa com Deficiência e Altas Habilidades - FUN";
            case "FUNDO ESTADUAL PARA A CRIANCA E O ADOLESCENTE" -> "Fundo Estadual para a Criança e o Adolescente";
            case "FUNDO ESTADUAL DE DEFESA DO CONSUMIDOR" -> "Fundo Estadual de Defesa do Consumidor";
            case "FUNDO ESTADUAL SOBRE DROGAS - FUNED" -> "Fundo Estadual sobre Drogas - FUNED";
            case "FUNDO ESTADUAL DO TRABALHO" -> "Fundo Estadual do Trabalho";
            case "AGENCIA ESTADUAL DE REGULACAO DOS SERVICOS PUBLICOS DELEGADOS DO ESTADO DO RS" -> "Agência Estadual de Regulação dos Serviços Públicos Delegados do Estado do RS";
            case "ENCARGOS GERAIS DA AGENCIA ESTADUAL DE REGULACAO DOS SERVICOS PUBLICOS DELEGADOS" -> "Encargos Gerais da Agência Estadual de Regulação dos Serviços Públicos Delegados";
            case "TRIBUNAL DE JUSTICA" -> "Tribunal de Justiça";
            case "ENCARGOS GERAIS DO TRIBUNAL DE JUSTICA" -> "Encargos Gerais do Tribunal de Justiça";
            case "UNIDADE PREVIDENCIARIA DESCENTRALIZADA - UPD - TJ" -> "Unidade Previdenciária Descentralizada - UPD - TJ";
            case "FUNDO DE REAPARELHAMENTO DO PODER JUDICIARIO" -> "Fundo de Reaparelhamento do Poder Judiciário";
            case "FUNDO NOTARIAL E REGISTRAL" -> "Fundo Notarial e Registral";
            case "JUSTICA MILITAR DO ESTADO" -> "Justiça Militar do Estado";
            case "ENCARGOS GERAIS DA JUSTICA MILITAR" -> "Encargos Gerais da Justiça Militar";
            case "UNIDADE PREVIDENCIARIA DESCENTRALIZADA - UPD - TJM" -> "Unidade Previdenciária Descentralizada - UPD - TJM";
            case "PROCURADORIA-GERAL DE JUSTICA" -> "Procuradoria-Geral de Justiça";
            case "ENCARGOS GERAIS DO MINISTERIO PUBLICO" -> "Encargos Gerais do Ministério Público";
            case "UNIDADE PREVIDENCIARIA DESCENTRALIZADA - UPD - MP" -> "Unidade Previdenciária Descentralizada - UPD - MP";
            case "FUNDO DE REAPARELHAMENTO DO MP" -> "Fundo de Reaparelhamento do MP";
            case "FUNDO PARA RECONSTITUICAO DE BENS LESADOS" -> "Fundo para Reconstituição de Bens Lesados";
            case "TRIBUNAL DE CONTAS DO ESTADO" -> "Tribunal de Contas do Estado";
            case "ENCARGOS GERAIS DO TRIBUNAL DE CONTAS DO ESTADO" -> "Encargos Gerais do Tribunal de Contas do Estado";
            case "UNIDADE PREVIDENCIARIA DESCENTRALIZADA - UPD - TCE" -> "Unidade Previdenciária Descentralizada - UPD - TCE";
            case "FUNDO DE REAPARELHAMENTO DO TRIBUNAL DE CONTAS DO ESTADO" -> "Fundo de Reaparelhamento do Tribunal de Contas do Estado";
            case "DEFENSORIA PUBLICA DO ESTADO" -> "Defensoria Pública do Estado";
            case "ENCARGOS GERAIS DA DEFENSORIA PUBLICA" -> "Encargos Gerais da Defensoria Pública";
            case "UNIDADE PREVIDENCIARIA DESCENTRALIZADA - UPD - DP" -> "Unidade Previdenciária Descentralizada - UPD - DP";
            case "FUNDO DE APARELHAMENTO DA DEFENSORIA PUBLICA" -> "Fundo de Aparelhamento da Defensoria Pública";
            case "ASSEMBLEIA LEGISLATIVA" -> "Assembleia Legislativa";
            case "ENCARGOS GERAIS DA ASSEMBLEIA LEGISLATIVA" -> "Encargos Gerais da Assembleia Legislativa";
            case "UNIDADE PREVIDENCIARIA DESCENTRALIZADA - UPD - AL" -> "Unidade Previdenciária Descentralizada - UPD - AL";
            case "FUNDO DE REAPARELHAMENTO DA ASSEMBLEIA LEGISLATIVA" -> "Fundo de Reaparelhamento da Assembleia Legislativa";
            case "ENCARGOS GERAIS DA UNIVERSIDADE ESTADUAL DO RIO GRANDE DO SUL." -> "Encargos Gerais da Universidade Estadual do Rio Grande do Sul";
            case "GABINETE E ORGAOS CENTRAIS." -> "Gabinete e Orgãos Centrais";
            case "GABINETE E ORGAOS CENTRAIS ." -> "Gabinete e Orgãos Centrais";
            case "SENTENCAS JUDICIARIAS - PRECATORIOS E RPVs" -> "Sentenças Judiciais - Precatórios e RPVs";
            default -> unidadeGestora.getNameUnidadeGestora();
        };
        unidadeGestora.setNameUnidadeGestora(updatedName);
    }
    ...
    private void correctElementDespesaNames(ElementoDespesa elementoDespesa) {
        String updatedName = switch (elementoDespesa.getNameElementoDespesa()) {
            ...
            case "AUXILIO FARDAMENTO" -> "Auxílio Fardamento";
            case "CONTRATACAO POR TEMPO DETERMINADO" -> "Contratação por Tempo Determinado";
            case "OUTROS BENEFICIOS ASSISTENCIAS" -> "Outros Benefícios Assistências";
            case "CONTRATO DE GESTAO" -> "Contrato de Gestão";
            case "CONCESSAO DE EMPRESTIMOS E FINANCIAMENTOS" -> "Concessão de Empréstimos e Financiamentos";
